...
class Sudoku {
    ...
    private boolean checkBlock (int val, int row, int col) {
        int rowMark = row / sdim;
        int colMark = col / sdim;
        for (int i = rowMark*sdim; i < (rowMark*sdim) + sdim; i++) {
            for (int j = colMark*sdim; j < (colMark*sdim) + sdim; j++) {
